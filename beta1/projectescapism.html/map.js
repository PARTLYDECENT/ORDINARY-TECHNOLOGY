...
const MapManager = (function () {
    ...
    class MapManager {
        ...
        _generateChunk(cx, cz) {
            ...
            [sdfBunkers, pillars, trees, rocks, debris, barrels].forEach(m => {
                m.castShadow = true; m.receiveShadow = true;
            });

            let sdfCount = 0, pCount = 0, tCount = 0, rCount = 0, dCount = 0, brlCount = 0;
            ...
            sdfBunkers.count = sdfCount; pillars.count = pCount; trees.count = tCount; rocks.count = rCount; dCount = dCount; barrels.count = brlCount;
