	...
	// Creative WebGL rendering system with backrooms uncanny alien world vibes
	...
	(function() {
	    ...
	    // =================================================================================================
	    // [SHADER SOURCE CODE] :: GLSL 3.00 ES - BACKROOMS UNCANNY ALIEN WORLD VIBES
	    // =================================================================================================
	    ...
	    const fragmentShaderSource = `#version 300 es
	        ...
	        vec3 staticInterference(vec2 uv, float t) {
	            float static = hash(uv + t);
	            static = step(0.95, static);
	            vec3 baseColor = backroomsBrown * 0.7;
	            vec3 staticColor = vec3(1.0) * static;
	            return mix(baseColor, staticColor, static);
	        }
	        ...
	        void main() {
	            ...
	            if (phaseIndex == 0) {
	                ...
	                color = staticInterference(uv, u_time);
	            }
